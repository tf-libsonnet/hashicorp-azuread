...
`azuread.string.withPostalCode` constructs a mixin object that can be merged into the `string`
...
`azuread.string.withStreetAddress` constructs a mixin object that can be merged into the `string`
