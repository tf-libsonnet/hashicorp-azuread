...
`azuread.service_principal_password.withDisplayName` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withEndDate` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withEndDateRelative` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withRotateWhenChanged` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withServicePrincipalId` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withStartDate` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withTimeouts` constructs a mixin object that can be merged into the `service_principal_password`
...
`azuread.service_principal_password.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_principal_password`
Terraform resource block to set or update the timeouts field.
