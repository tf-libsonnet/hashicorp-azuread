...
`azuread.service_principal.withAccountEnabled` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withAlternativeNames` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withAppRoleAssignmentRequired` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withDescription` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withFeatureTags` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withFeatureTagsMixin` constructs a mixin object that can be merged into the `service_principal`
Terraform resource block to set or update the feature_tags field.
...
`azuread.service_principal.withFeatures` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withFeaturesMixin` constructs a mixin object that can be merged into the `service_principal`
Terraform resource block to set or update the features field.
...
`azuread.service_principal.withLoginUrl` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withNotes` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withNotificationEmailAddresses` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withOwners` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withPreferredSingleSignOnMode` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withSamlSingleSignOn` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withSamlSingleSignOnMixin` constructs a mixin object that can be merged into the `service_principal`
Terraform resource block to set or update the saml_single_sign_on field.
...
`azuread.service_principal.withTags` constructs a mixin object that can be merged into the `service_principal`
...
`azuread.service_principal.withUseExisting` constructs a mixin object that can be merged into the `service_principal`
