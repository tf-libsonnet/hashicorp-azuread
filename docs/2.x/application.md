...
`azuread.application.withApi` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withApiMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the api field.
...
`azuread.application.withAppRole` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withAppRoleMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the app_role field.
...
`azuread.application.withDeviceOnlyAuthEnabled` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withFallbackPublicClientEnabled` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withFeatureTags` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withFeatureTagsMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the feature_tags field.
...
`azuread.application.withGroupMembershipClaims` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withIdentifierUris` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withLogoImage` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withMarketingUrl` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withOauth2PostResponseRequired` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withOptionalClaims` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withOptionalClaimsMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the optional_claims field.
...
`azuread.application.withOwners` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withPreventDuplicateNames` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withPrivacyStatementUrl` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withPublicClient` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withPublicClientMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the public_client field.
...
`azuread.application.withRequiredResourceAccess` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withRequiredResourceAccessMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the required_resource_access field.
...
`azuread.application.withSignInAudience` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withSinglePageApplication` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withSinglePageApplicationMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the single_page_application field.
...
`azuread.application.withSupportUrl` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withTags` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withTemplateId` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withTermsOfServiceUrl` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withWeb` constructs a mixin object that can be merged into the `application`
...
`azuread.application.withWebMixin` constructs a mixin object that can be merged into the `application`
Terraform resource block to set or update the web field.
