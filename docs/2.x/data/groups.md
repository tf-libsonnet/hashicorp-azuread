...
`azuread.groups.withDisplayNamePrefix` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withDisplayNames` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withIgnoreMissing` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withMailEnabled` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withObjectIds` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withReturnAll` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withSecurityEnabled` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withTimeouts` constructs a mixin object that can be merged into the `groups`
...
`azuread.groups.withTimeoutsMixin` constructs a mixin object that can be merged into the `groups`
Terraform data source block to set or update the timeouts field.
