...
`azuread.domains.withAdminManaged` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withIncludeUnverified` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withOnlyDefault` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withOnlyInitial` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withOnlyRoot` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withSupportsServices` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withTimeouts` constructs a mixin object that can be merged into the `domains`
...
`azuread.domains.withTimeoutsMixin` constructs a mixin object that can be merged into the `domains`
Terraform data source block to set or update the timeouts field.
