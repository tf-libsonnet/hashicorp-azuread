---
permalink: /data/access_package_catalog_role/
---

# data.access_package_catalog_role

`access_package_catalog_role` represents the `azuread_access_package_catalog_role` Terraform data source.
