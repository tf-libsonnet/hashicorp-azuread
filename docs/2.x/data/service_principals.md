...
`azuread.service_principals.withApplicationIds` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withDisplayNames` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withIgnoreMissing` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withObjectIds` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withReturnAll` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withTimeouts` constructs a mixin object that can be merged into the `service_principals`
...
`azuread.service_principals.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_principals`
Terraform data source block to set or update the timeouts field.
