...
`azuread.invitation.withMessage` constructs a mixin object that can be merged into the `invitation`
...
`azuread.invitation.withMessageMixin` constructs a mixin object that can be merged into the `invitation`
Terraform resource block to set or update the message field.
...
`azuread.invitation.withRedirectUrl` constructs a mixin object that can be merged into the `invitation`
...
`azuread.invitation.withTimeouts` constructs a mixin object that can be merged into the `invitation`
...
`azuread.invitation.withTimeoutsMixin` constructs a mixin object that can be merged into the `invitation`
Terraform resource block to set or update the timeouts field.
...
`azuread.invitation.withUserDisplayName` constructs a mixin object that can be merged into the `invitation`
...
`azuread.invitation.withUserEmailAddress` constructs a mixin object that can be merged into the `invitation`
...
`azuread.invitation.withUserType` constructs a mixin object that can be merged into the `invitation`
