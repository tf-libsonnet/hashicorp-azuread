...
`azuread.conditional_access_policy.withConditions` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withConditionsMixin` constructs a mixin object that can be merged into the `conditional_access_policy`
Terraform resource block to set or update the conditions field.
...
`azuread.conditional_access_policy.withDisplayName` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withGrantControls` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withGrantControlsMixin` constructs a mixin object that can be merged into the `conditional_access_policy`
Terraform resource block to set or update the grant_controls field.
...
`azuread.conditional_access_policy.withSessionControls` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withSessionControlsMixin` constructs a mixin object that can be merged into the `conditional_access_policy`
Terraform resource block to set or update the session_controls field.
...
`azuread.conditional_access_policy.withState` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withTimeouts` constructs a mixin object that can be merged into the `conditional_access_policy`
...
`azuread.conditional_access_policy.withTimeoutsMixin` constructs a mixin object that can be merged into the `conditional_access_policy`
Terraform resource block to set or update the timeouts field.
