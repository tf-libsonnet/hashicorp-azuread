...
`azuread.group.withAssignableToRole` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withAutoSubscribeNewMembers` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withBehaviors` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withDescription` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withDynamicMembership` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withDynamicMembershipMixin` constructs a mixin object that can be merged into the `group`
Terraform resource block to set or update the dynamic_membership field.
...
`azuread.group.withExternalSendersAllowed` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withHideFromAddressLists` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withHideFromOutlookClients` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withMailNickname` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withMembers` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withOwners` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withPreventDuplicateNames` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withProvisioningOptions` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withTheme` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withTypes` constructs a mixin object that can be merged into the `group`
...
`azuread.group.withVisibility` constructs a mixin object that can be merged into the `group`
