---
permalink: /application_known_clients/
---

# application_known_clients

`application_known_clients` represents the `azuread_application_known_clients` Terraform resource.
...
* [`fn withKnownClientIds()`](#fn-withknownclientids)
...
### fn withKnownClientIds

```ts
withKnownClientIds()
```

`azuread.list.withKnownClientIds` constructs a mixin object that can be merged into the `list`
