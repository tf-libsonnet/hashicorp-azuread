...
`azuread.custom_directory_role.withDescription` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withDisplayName` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withEnabled` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withPermissions` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withPermissionsMixin` constructs a mixin object that can be merged into the `custom_directory_role`
Terraform resource block to set or update the permissions field.
...
`azuread.custom_directory_role.withTemplateId` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withTimeouts` constructs a mixin object that can be merged into the `custom_directory_role`
...
`azuread.custom_directory_role.withTimeoutsMixin` constructs a mixin object that can be merged into the `custom_directory_role`
Terraform resource block to set or update the timeouts field.
...
`azuread.custom_directory_role.withVersion` constructs a mixin object that can be merged into the `custom_directory_role`
