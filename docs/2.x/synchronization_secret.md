...
`azuread.synchronization_secret.withCredential` constructs a mixin object that can be merged into the `synchronization_secret`
...
`azuread.synchronization_secret.withCredentialMixin` constructs a mixin object that can be merged into the `synchronization_secret`
Terraform resource block to set or update the credential field.
...
`azuread.synchronization_secret.withServicePrincipalId` constructs a mixin object that can be merged into the `synchronization_secret`
...
`azuread.synchronization_secret.withTimeouts` constructs a mixin object that can be merged into the `synchronization_secret`
...
`azuread.synchronization_secret.withTimeoutsMixin` constructs a mixin object that can be merged into the `synchronization_secret`
Terraform resource block to set or update the timeouts field.
