...
`azuread.service_principal_delegated_permission_grant.withTimeouts` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`
