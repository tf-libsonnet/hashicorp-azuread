...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azuread.application_certificate.timeouts.new](#fn-application_certificatetimeoutsnew) constructor.
...
Unlike [azuread.application_certificate.new](#fn-application_certificatenew), this function will not inject the `resource`
