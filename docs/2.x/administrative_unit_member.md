...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azuread.administrative_unit_member.timeouts.new](#fn-administrative_unit_membertimeoutsnew) constructor.
...
Unlike [azuread.administrative_unit_member.new](#fn-administrative_unit_membernew), this function will not inject the `resource`
