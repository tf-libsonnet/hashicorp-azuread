...
**Args**:
  ...
  - `timeouts` (`obj`):  When `null`, the `timeouts` sub block will be omitted from the resulting object. When setting the sub block, it is recommended to construct the object using the [azuread.administrative_unit.timeouts.new](#fn-administrative_unittimeoutsnew) constructor.
...
Unlike [azuread.administrative_unit.new](#fn-administrative_unitnew), this function will not inject the `resource`
