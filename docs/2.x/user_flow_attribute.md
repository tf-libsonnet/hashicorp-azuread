---
permalink: /user_flow_attribute/
---

# user_flow_attribute

`user_flow_attribute` represents the `azuread_user_flow_attribute` Terraform resource.
...
`azuread.string.withDataType` constructs a mixin object that can be merged into the `string`
