...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAdministrativeUnitIds':: d.fn(help='`azuread.list.withAdministrativeUnitIds` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the administrative_unit_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `administrative_unit_ids` field.\n', args=[]),
  withAdministrativeUnitIds(resourceLabel, value): {
    resource+: {
      azuread_group+: {
        [resourceLabel]+: {
          administrative_unit_ids: value,
        },
      },
    },
  },
  ...
  '#withOnpremisesGroupType':: d.fn(help='`azuread.string.withOnpremisesGroupType` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the onpremises_group_type field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `onpremises_group_type` field.\n', args=[]),
  withOnpremisesGroupType(resourceLabel, value): {
    resource+: {
      azuread_group+: {
        [resourceLabel]+: {
          onpremises_group_type: value,
        },
      },
    },
  },
  ...
  '#withWritebackEnabled':: d.fn(help='`azuread.bool.withWritebackEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the writeback_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `writeback_enabled` field.\n', args=[]),
  withWritebackEnabled(resourceLabel, value): {
    resource+: {
      azuread_group+: {
        [resourceLabel]+: {
