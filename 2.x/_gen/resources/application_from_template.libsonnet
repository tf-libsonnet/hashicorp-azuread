...
{
  '#':: d.pkg(name='application_from_template', url='', help='`application_from_template` represents the `azuread_application_from_template` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  new(
    ...
    type='azuread_application_from_template',
    label=resourceLabel,
