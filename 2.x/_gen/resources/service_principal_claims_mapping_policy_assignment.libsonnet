...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClaimsMappingPolicyId':: d.fn(help='`azuread.service_principal_claims_mapping_policy_assignment.withClaimsMappingPolicyId` constructs a mixin object that can be merged into the `service_principal_claims_mapping_policy_assignment`\nTerraform resource block to set or update the claims_mapping_policy_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `claims_mapping_policy_id` field.\n', args=[]),
  ...
  '#withServicePrincipalId':: d.fn(help='`azuread.service_principal_claims_mapping_policy_assignment.withServicePrincipalId` constructs a mixin object that can be merged into the `service_principal_claims_mapping_policy_assignment`\nTerraform resource block to set or update the service_principal_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_principal_id` field.\n', args=[]),
