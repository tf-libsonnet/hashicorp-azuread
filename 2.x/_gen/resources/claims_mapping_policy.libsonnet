...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefinition':: d.fn(help='`azuread.claims_mapping_policy.withDefinition` constructs a mixin object that can be merged into the `claims_mapping_policy`\nTerraform resource block to set or update the definition field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `definition` field.\n', args=[]),
  ...
  '#withDisplayName':: d.fn(help='`azuread.claims_mapping_policy.withDisplayName` constructs a mixin object that can be merged into the `claims_mapping_policy`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
