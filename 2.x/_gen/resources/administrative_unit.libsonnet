...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDescription':: d.fn(help='`azuread.administrative_unit.withDescription` constructs a mixin object that can be merged into the `administrative_unit`\nTerraform resource block to set or update the description field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `description` field.\n', args=[]),
  ...
  '#withHiddenMembershipEnabled':: d.fn(help='`azuread.administrative_unit.withHiddenMembershipEnabled` constructs a mixin object that can be merged into the `administrative_unit`\nTerraform resource block to set or update the hidden_membership_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `hidden_membership_enabled` field.\n', args=[]),
  ...
  '#withMembers':: d.fn(help='`azuread.administrative_unit.withMembers` constructs a mixin object that can be merged into the `administrative_unit`\nTerraform resource block to set or update the members field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `members` field.\n', args=[]),
  ...
  '#withPreventDuplicateNames':: d.fn(help='`azuread.administrative_unit.withPreventDuplicateNames` constructs a mixin object that can be merged into the `administrative_unit`\nTerraform resource block to set or update the prevent_duplicate_names field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `prevent_duplicate_names` field.\n', args=[]),
