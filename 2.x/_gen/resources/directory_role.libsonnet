...
{
  '#':: d.pkg(name='directory_role', url='', help='`directory_role` represents the `azuread_directory_role` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withDisplayName':: d.fn(help='`azuread.directory_role.withDisplayName` constructs a mixin object that can be merged into the `directory_role`\nTerraform resource block to set or update the display_name field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withTemplateId':: d.fn(help='`azuread.directory_role.withTemplateId` constructs a mixin object that can be merged into the `directory_role`\nTerraform resource block to set or update the template_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.directory_role.withTimeouts` constructs a mixin object that can be merged into the `directory_role`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.directory_role.withTimeoutsMixin` constructs a mixin object that can be merged into the `directory_role`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.directory_role.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
