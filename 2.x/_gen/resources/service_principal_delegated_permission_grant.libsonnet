...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withClaimValues':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withClaimValues` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the claim_values field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `claim_values` field.\n', args=[]),
  ...
  '#withResourceServicePrincipalObjectId':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withResourceServicePrincipalObjectId` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the resource_service_principal_object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `resource_service_principal_object_id` field.\n', args=[]),
  ...
  '#withServicePrincipalObjectId':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withServicePrincipalObjectId` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the service_principal_object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_principal_object_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withTimeouts` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.service_principal_delegated_permission_grant.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withUserObjectId':: d.fn(help='`azuread.service_principal_delegated_permission_grant.withUserObjectId` constructs a mixin object that can be merged into the `service_principal_delegated_permission_grant`\nTerraform resource block to set or update the user_object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `user_object_id` field.\n', args=[]),
