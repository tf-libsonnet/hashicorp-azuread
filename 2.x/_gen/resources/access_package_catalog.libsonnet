...
{
  '#':: d.pkg(name='access_package_catalog', url='', help='`access_package_catalog` represents the `azuread_access_package_catalog` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
  ...
  '#withExternallyVisible':: d.fn(help='`azuread.bool.withExternallyVisible` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the externally_visible field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `externally_visible` field.\n', args=[]),
  withExternallyVisible(resourceLabel, value): {
    resource+: {
      azuread_access_package_catalog+: {
        [resourceLabel]+: {
          externally_visible: value,
        },
      },
    },
  },
  '#withPublished':: d.fn(help='`azuread.bool.withPublished` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the published field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `published` field.\n', args=[]),
