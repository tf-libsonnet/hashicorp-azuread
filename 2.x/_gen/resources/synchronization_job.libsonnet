...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withEnabled':: d.fn(help='`azuread.synchronization_job.withEnabled` constructs a mixin object that can be merged into the `synchronization_job`\nTerraform resource block to set or update the enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `enabled` field.\n', args=[]),
  ...
  '#withServicePrincipalId':: d.fn(help='`azuread.synchronization_job.withServicePrincipalId` constructs a mixin object that can be merged into the `synchronization_job`\nTerraform resource block to set or update the service_principal_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `service_principal_id` field.\n', args=[]),
  ...
  '#withTemplateId':: d.fn(help='`azuread.synchronization_job.withTemplateId` constructs a mixin object that can be merged into the `synchronization_job`\nTerraform resource block to set or update the template_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.synchronization_job.withTimeouts` constructs a mixin object that can be merged into the `synchronization_job`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.synchronization_job.withTimeoutsMixin` constructs a mixin object that can be merged into the `synchronization_job`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.synchronization_job.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
