...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAuthorizedClientId':: d.fn(help='`azuread.string.withAuthorizedClientId` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the authorized_client_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `authorized_client_id` field.\n', args=[]),
  withAuthorizedClientId(resourceLabel, value): {
    resource+: {
      azuread_application_pre_authorized+: {
        [resourceLabel]+: {
          authorized_client_id: value,
        },
      },
    },
  },
