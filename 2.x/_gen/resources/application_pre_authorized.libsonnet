...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationObjectId':: d.fn(help='`azuread.application_pre_authorized.withApplicationObjectId` constructs a mixin object that can be merged into the `application_pre_authorized`\nTerraform resource block to set or update the application_object_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_object_id` field.\n', args=[]),
  ...
  '#withAuthorizedAppId':: d.fn(help='`azuread.application_pre_authorized.withAuthorizedAppId` constructs a mixin object that can be merged into the `application_pre_authorized`\nTerraform resource block to set or update the authorized_app_id field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `authorized_app_id` field.\n', args=[]),
  ...
  '#withPermissionIds':: d.fn(help='`azuread.application_pre_authorized.withPermissionIds` constructs a mixin object that can be merged into the `application_pre_authorized`\nTerraform resource block to set or update the permission_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `permission_ids` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.application_pre_authorized.withTimeouts` constructs a mixin object that can be merged into the `application_pre_authorized`\nTerraform resource block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.application_pre_authorized.withTimeoutsMixin` constructs a mixin object that can be merged into the `application_pre_authorized`\nTerraform resource block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.application_pre_authorized.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
