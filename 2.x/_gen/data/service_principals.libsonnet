...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withApplicationIds':: d.fn(help='`azuread.service_principals.withApplicationIds` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the application_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `application_ids` field.\n', args=[]),
  ...
  '#withDisplayNames':: d.fn(help='`azuread.service_principals.withDisplayNames` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the display_names field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_names` field.\n', args=[]),
  ...
  '#withIgnoreMissing':: d.fn(help='`azuread.service_principals.withIgnoreMissing` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the ignore_missing field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `ignore_missing` field.\n', args=[]),
  ...
  '#withObjectIds':: d.fn(help='`azuread.service_principals.withObjectIds` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the object_ids field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object_ids` field.\n', args=[]),
  ...
  '#withReturnAll':: d.fn(help='`azuread.service_principals.withReturnAll` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the return_all field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `return_all` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.service_principals.withTimeouts` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.service_principals.withTimeoutsMixin` constructs a mixin object that can be merged into the `service_principals`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.service_principals.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
