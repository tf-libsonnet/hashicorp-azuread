...
{
  '#':: d.pkg(name='directory_object', url='', help='`directory_object` represents the `azuread_directory_object` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withObjectId':: d.fn(help='`azuread.directory_object.withObjectId` constructs a mixin object that can be merged into the `directory_object`\nTerraform data source block to set or update the object_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `object_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.directory_object.withTimeouts` constructs a mixin object that can be merged into the `directory_object`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.directory_object.withTimeoutsMixin` constructs a mixin object that can be merged into the `directory_object`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.directory_object.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
