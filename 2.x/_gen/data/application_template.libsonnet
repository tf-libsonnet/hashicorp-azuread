...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDisplayName':: d.fn(help='`azuread.application_template.withDisplayName` constructs a mixin object that can be merged into the `application_template`\nTerraform data source block to set or update the display_name field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `display_name` field.\n', args=[]),
  ...
  '#withTemplateId':: d.fn(help='`azuread.application_template.withTemplateId` constructs a mixin object that can be merged into the `application_template`\nTerraform data source block to set or update the template_id field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `template_id` field.\n', args=[]),
  ...
  '#withTimeouts':: d.fn(help='`azuread.application_template.withTimeouts` constructs a mixin object that can be merged into the `application_template`\nTerraform data source block to set or update the timeouts field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
  ...
  '#withTimeoutsMixin':: d.fn(help='`azuread.application_template.withTimeoutsMixin` constructs a mixin object that can be merged into the `application_template`\nTerraform data source block to set or update the timeouts field.\n\nThis function will merge the passed in value to the existing map. If you wish\nto instead replace the entire map with the passed in `value`, use the [azuread.application_template.withTimeouts](TODO)\nfunction.\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `timeouts` field.\n', args=[]),
