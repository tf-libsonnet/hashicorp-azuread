...
{
  '#':: d.pkg(name='directory_role_templates', url='', help='`directory_role_templates` represents the `azuread_directory_role_templates` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    type='azuread_directory_role_templates',
    label=dataSrcLabel,
